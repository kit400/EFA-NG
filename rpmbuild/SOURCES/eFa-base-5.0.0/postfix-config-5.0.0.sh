...
postconf -e "smtp_tls_session_cache_database = lmdb:/var/lib/postfix/smtp_tls_session_cache"
...
postconf -e "smtpd_tls_session_cache_database = lmdb:/var/lib/postfix/smtpd_tls_session_cache"
